...
\end{array}\right.
\]
Sabemos que $PA\subseteq NA$ y aplicando el funtor $\pt$ obtenemos $\pt NA\subseteq \pt PA$. Por lo tanto $w_p\in \pt PA$. De esta manera, para $p\in \pt A$ decimos que $p$ es un punto ajusto si $w_p$ es un núcleo ajustado.\\
...
En la siguiente lista se presentan las principales actividades que realizaré durante el semestre 2026 periodo que abarca mi estancia del 6to semestre dentro del
