...
\item Definir las nociones libres de puntos de apilado y fuertemente apilado. $(\checkmark)$
\item Verificar si las nociones anteriores son conservativas o no. $(\checkmark)$
...
\item Leer el artículo \cite{klinke2013yet} y comprender los detalles de su construcción de parches. Adaptar algunos de los resultados que el presenta, pero para $PA$.
\item Dar condiciones sobre $PA$ para que cumpla las propiedades de separación mencionadas anteriormente.
\item Para un marco $A$ realizar el cálculo de $P^2A$ y $P^3A$. Ver la relación que existe entre $PA$, $P^2A$ y $P^3A$.
\end{enumerate}
