...
Resulta natural el pensar que la propiedad $\mathbf{(H)}$ este metida entre ellas. La realidad es que hasta el día de hoy no hemos logrado demostrar que 
\[
...
De esta manera, el siguiente diagrama reúne la información proporcionada por el Lema \ref{TadyFHausdorff}, la Observación \ref{Relacion arreglado} y la pregunta abierta que aun existe sobre la relación que podria proporcionar la propiedad $\mathbf{(H)}$.
\[\begin{tikzcd}
	{\mathbf{(aju)}} \\
...
Con el diagrama anterior podríamos analizar más a fondo algunos casos particulares de cocientes, por ejemplo los \emph{cocientes compactos}, los cuales serán abordados en el Capítulo \ref{MarcosKC}. 
%Por el momento, 
