...
\begin{enumerate}
  \item Se realizó la escritura de este documento con el objetivo de organizar y sistematizar los resultados obtenidos hasta el momento.
  ...
  \item Se redactaron los detalles de la demostración del Teorema \ref{haus1}. Además, se reestructuró la Proposición \ref{morfismo} junto con su demostración y se enunció y demostró la Proposición \ref{igualdadwF}.
\end{enumerate}
