...
La anterior es la noción topológica introducida por Sexton y Simmons en \cite{sexton2006ordinal} (Definición 6.1) y cumple
que fuertemente apilado implica apilado. Nosotros damos sus análogos en la teoría de marcos, es decir, 
...
\begin{enumerate}
  \item Definimos las nociones de marcos apilados y fuertemente apilados.
  \item Verificamos que las nociones anteriores son conservativas.
  \item Analizamos algunas de las propiedades que tiene el marco $[0,1]$ y su construcción de parches.
\end{enumerate}
