...
Siguiendo la idea mostrada en (\ref{eq:derivada}), podemos ver que la $Q$-derivada es el complemento del núcleo ajustado asociado al filtro abierto correspondiente a $Q$, es decir,
\begin{equation}\label{eq:complemento}
  Q(\alpha)(X)=(v_F^{\alpha}(X'))'
\end{equation}
donde $X\in \mathcal{C}S$.
